...
const MyBookings = () => {
  ...
  if (!hotels || hotels.length === 0) {
    return <h1 className="text-3xl font-bold">No Bookings Found</h1>;
  }
          ...
          <div className="flex flex-col gap-4 overflow-y-auto max-h-[300px]">
            ...
            {hotel.bookings.map((booking) => (
              <div>
                ...
                <div>
                  <span className="font-bold mr-2">Extra Beds:</span>
                  <span>{booking.extraBedCount} extra beds</span>
                </div>
                <div>
                ...
                <div>
                  <span className="font-bold mr-2">Discount Obtained:</span>
                  <span>₹{booking.discountObtained}</span>
                </div>
                <div>
