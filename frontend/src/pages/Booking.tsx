...
import { CouponType, HotelType, PaymentIntentResponse } from "../shared/types";
  ...
  return (
    <div className="grid md:grid-cols-[1fr_2fr]">
      <div>
        ...
        {couponError && (
          <p className="text-red-500 font-semibold text-sm my-4 mx-2">
            {couponError}
          </p>
        )}
        <div className="my-4 mx-2">
          <h2 className="text-xl font-bold mt-4">
            ...
            {discountedTotal !== null
              ...
              : paymentIntentData?.totalCost.toFixed(2) ?? "Calculating..."}
          </h2>
        </div>
